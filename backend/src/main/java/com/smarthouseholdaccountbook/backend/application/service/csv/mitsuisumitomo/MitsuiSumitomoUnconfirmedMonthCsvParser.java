 ...
 */
@Component
public class MitsuiSumitomoUnconfirmedMonthCsvParser implements CsvParser {

    private static final Logger logger = LoggerFactory.getLogger(MitsuiSumitomoUnconfirmedMonthCsvParser.class);
    ...
    private static final MitsuiSumitomoCsvParseUtil.Config CONFIG = new MitsuiSumitomoCsvParseUtil.Config(
            ...
            false // checkTotalLine（未確定月CSVには合計行がない）
    );
